...
const INDUSTRY_RECOMMENDATIONS: Record<Industry, IndustryRecommendation> = {
  technology: {
    ...
    primaryMood: "modern",
    avoidMoods: ["traditional", "playful"],
  ...
  healthcare: {
    ...
    avoidMoods: ["bold", "bold", "traditional"],
  ...
  logistics: {
    ...
    primaryMood: "professional",
    avoidMoods: ["elegant", "playful", "playful"],
  ...
  real_estate: {
    ...
    primaryMood: "elegant",
    avoidMoods: ["playful", "bold", "modern"],
