...
export async function createAssetLibraryItem(input: CreateAssetInput): Promise<AssetLibraryView> {
  ...
  publishSafe({ eventType: "asset_library_upload", sourceModule: "asset-library", payload: {
    emailHash: input.emailHash,
    assetId: inserted.id,
    category: input.category,
    uploadedBy: input.uploadedBy,
...
export async function replaceAssetLibraryItem(input: ReplaceAssetInput): Promise<AssetLibraryView> {
  ...
  publishSafe({ eventType: "asset_library_replaced", sourceModule: "asset-library", payload: {
    emailHash: input.emailHash,
...
export async function signAssetLibraryDownload(
  ...
  publishSafe({ eventType: "asset_library_download", sourceModule: "asset-library", payload: {
    emailHash,
    assetId: id,
