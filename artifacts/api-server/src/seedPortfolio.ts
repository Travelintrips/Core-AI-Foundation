...
const PORTFOLIO_SEEDS: Record<string, PortfolioSeed[]> = {
  "logo-design": [
    ...
    // Restaurant
    {
      ...
      coverImage: "https://images.unsplash.com/photo-1634942537034-2531766767d1?w=1200&q=80",
      deliverablesJson: ["png", "svg", "pdf"], toolsUsedJson: ["Creative Director AI", "Designer AI"],
    ...
    // Property
    {
      ...
      coverImage: "https://images.unsplash.com/photo-1586717799252-bd134ad00e26?w=1200&q=80",
      deliverablesJson: ["png", "svg", "pdf"], toolsUsedJson: ["Creative Director AI", "Designer AI"],
    ...
    // Technology
    {
      ...
      coverImage: "https://images.unsplash.com/photo-1613909207039-6b173b755cc1?w=1200&q=80",
      deliverablesJson: ["png", "svg", "pdf"], toolsUsedJson: ["Creative Director AI", "Designer AI"],
    ...
    // Trading
    {
      ...
      coverImage: "https://images.unsplash.com/photo-1572044162444-ad60f128bdea?w=1200&q=80",
      deliverablesJson: ["png", "svg", "pdf"], toolsUsedJson: ["Creative Director AI", "Designer AI"],
