...
// ── Pagination helper ─────────────────────────────────────────────────────────
// MAX_PAGE_LIMIT caps all list endpoints. parsePagination is the single
// authoritative place to enforce it — do not remove or inline elsewhere.
// Regression guard: see __tests__/customer-creative-workspace.test.ts
