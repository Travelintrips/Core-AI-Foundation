...
const SERVICES: Record<string, ServiceSeed[]> = {
  creative: [
    ...
    svc("copywriting", "Copywriting", "Copy on-brand untuk caption, landing page, atau kampanye.", "one_time", "350000", "1-3 hari", false, ["Copywriter AI"], ["Copy document"]),
    ...
    svc("fashion-design", "Fashion Design Brief", "Brief koleksi fashion lengkap: brand DNA, konsep koleksi, arah warna & siluet, lookbook copy, analisis tren, dan campaign copy — dieksekusi 5-agent AI specialist fashion.", "one_time", "2500000", "3-5 hari", true, ["Fashion Brand Strategist AI", "Fashion Creative Director AI", "Fashion Collection Writer AI", "Fashion Trend Analyst AI"], ["Fashion design brief PDF", "Collection concept", "Lookbook copy", "Campaign copy", "Trend analysis"]),
    svc("interior-design", "Interior Design Proposal", "Proposal desain interior profesional: konsep ruang, space planning, spesifikasi material & furnitur, narasi desain, dan copywriting proyek — dieksekusi 5-agent AI specialist interior.", "one_time", "3000000", "3-5 hari", true, ["Interior Concept Architect AI", "Interior Space Planner AI", "Interior Material Specialist AI", "Interior Copywriter AI"], ["Interior design proposal PDF", "Space planning notes", "Material specification", "Design narrative"]),
  ],
  marketing: [
    ...
    svc("campaign-plan", "Rencana Kampanye", "Rencana kampanye marketing end-to-end.", "one_time", "1500000", "3-5 hari", false, ["Marketing Strategist AI"], ["Campaign plan document"]),
    svc("content-calendar", "Kalender Konten 30 Hari", "Kalender konten 30 hari lintas kanal.", "one_time", "500000", "2-3 hari", false, ["Marketing Strategist AI"], ["Content calendar"]),
    svc("competitor-analysis", "Analisis Kompetitor", "Analisis kompetitor untuk strategi pemasaran.", "one_time", "1250000", "3-5 hari", false, ["Marketing Strategist AI"], ["Competitor analysis report"]),
    ...
    svc("marketing-ai-monthly", "Marketing AI Bulanan", "Subscription strategi dan eksekusi marketing bulanan.", "monthly_subscription", "1250000", "Ongoing, bulanan", true, ["Marketing Strategist AI"], ["Monthly marketing plan", "Human review"]),
  ],
  sales: [
    ...
    svc("proposal-drafting", "Penyusunan Proposal Penjualan", "Penyusunan proposal penjualan yang dipersonalisasi.", "one_time", "500000", "1-2 hari", false, ["Sales AI"], ["Proposal document"]),
  ...
  finance: [
    ...
    svc("budget-planning", "Review Anggaran vs Realisasi", "Perbandingan anggaran vs realisasi.", "one_time", "2000000", "3-5 hari", true, ["Finance Analyst AI"], ["Budget review document"]),
    svc("forecasting", "Perkiraan Keuangan", "Model forecasting pendapatan dan pengeluaran.", "monthly_subscription", "3500000", "3-5 hari", true, ["Finance Analyst AI"], ["Forecast model", "Monthly updates"]),
    svc("profitability-analysis", "Analisis Laba Rugi", "Analisis profitabilitas produk/segmen.", "one_time", "1250000", "3-5 hari", false, ["Finance Analyst AI"], ["P&L analysis report"]),
    svc("bank-reconciliation", "Bantuan Rekonsiliasi Bank", "Rekonsiliasi otomatis laporan bank per periode.", "monthly_subscription", "2500000", "Ongoing, bulanan", false, ["Finance Analyst AI"], ["Reconciliation report"]),
    svc("management-report", "Laporan Keuangan Manajemen", "Paket laporan manajemen bulanan.", "monthly_subscription", "2500000", "Ongoing, bulanan", true, ["Finance Analyst AI"], ["Management report PDF"]),
  ],
  accounting: [
    ...
    svc("general-ledger-analysis", "Review General Ledger", "Analisis akun general ledger.", "one_time", "2000000", "2-4 hari", false, ["Accounting AI"], ["GL analysis report"]),
    svc("trial-balance-review", "Review Trial Balance", "Pemeriksaan akurasi trial balance.", "one_time", "2000000", "1-3 hari", true, ["Accounting AI"], ["Trial balance review notes"]),
    svc("closing-assistance", "Bantuan Proses Closing", "Dukungan proses closing bulanan/tahunan.", "monthly_subscription", "3500000", "Ongoing, per periode", true, ["Accounting AI"], ["Closing checklist", "Closing report"]),
  ...
  tax: [
    ...
    svc("tax-reconciliation", "Rekonsiliasi Pajak", "Rekonsiliasi pajak per periode.", "one_time", "3000000", "3-5 hari", true, ["Tax AI"], ["Tax reconciliation report"]),
    svc("tax-planning", "Perencanaan Pajak", "Strategi perencanaan pajak ke depan.", "one_time", "2500000", "4-6 hari", true, ["Tax AI"], ["Tax planning document"]),
    svc("invoice-validation", "Review Faktur Pajak", "Validasi massal faktur pajak.", "one_time", "500000", "Ongoing, per dokumen", false, ["Tax AI"], ["Validation report"]),
    svc("spt-review", "Review Kesiapan SPT", "Review SPT sebelum submisi.", "one_time", "2500000", "2-4 hari", true, ["Tax AI"], ["SPT review notes"]),
  ],
  hr: [
    ...
    svc("performance-summary", "Ringkasan Performa", "Ringkasan performa karyawan.", "one_time", "500000", "1-2 hari", false, ["HR AI"], ["Performance summary report"]),
  ...
  logistics: [
    ...
    svc("vendor-comparison", "Perbandingan Vendor", "Perbandingan penawaran vendor logistik.", "one_time", "500000", "1-2 hari", false, ["Logistics AI"], ["Vendor comparison sheet"]),
    svc("shipment-exception", "Analisis Pengecualian Pengiriman", "Analisis kasus pengecualian pengiriman.", "one_time", "500000", "1-2 hari", false, ["Logistics AI"], ["Exception analysis report"]),
    svc("rfq-generation", "Pembuatan RFQ", "Pembuatan dokumen RFQ otomatis.", "one_time", "250000", "1-2 hari", false, ["Logistics AI"], ["RFQ document"]),
    svc("logistics-ai-monthly", "Logistics AI Bulanan", "Subscription dukungan logistik bulanan.", "monthly_subscription", "2500000", "Ongoing, bulanan", true, ["Logistics AI"], ["Monthly logistics support"]),
  ],
  customs: [
    ...
    svc("lartas-checking", "Review Lartas", "Screening barang larangan/pembatasan (Lartas).", "one_time", "500000", "1-2 hari", true, ["Customs AI"], ["Lartas screening report"]),
    ...
    svc("customs-ai-monthly", "Customs AI Bulanan", "Subscription dukungan customs & PPJK bulanan.", "monthly_subscription", "2500000", "Ongoing, bulanan", true, ["Customs AI"], ["Monthly customs support"]),
  ],
  procurement: [
    ...
    svc("supplier-scorecard", "Scorecard Supplier", "Penilaian performa supplier.", "one_time", "1000000", "2-3 hari", false, ["Procurement AI"], ["Supplier scorecard"]),
    svc("spend-analysis", "Analisis Pengeluaran", "Analisis pengeluaran procurement.", "one_time", "2500000", "3-5 hari", true, ["Procurement AI"], ["Spend analysis report"]),
    svc("procurement-ai-monthly", "Procurement AI Bulanan", "Subscription dukungan procurement bulanan.", "monthly_subscription", "3500000", "Ongoing, bulanan", true, ["Procurement AI"], ["Monthly procurement support"]),
  ],
  trading: [
    svc("commercial-offer", "Penawaran Komersial", "Penyusunan penawaran komersial.", "one_time", "500000", "1-2 hari", false, ["Trading AI"], ["Commercial offer document"]),
    ...
    svc("margin-simulation", "Simulasi Margin", "Simulasi margin transaksi trading.", "one_time", "500000", "1-2 hari", false, ["Trading AI"], ["Margin simulation report"]),
    ...
    svc("trading-ai-monthly", "Trading AI Bulanan", "Subscription dukungan trading bulanan.", "monthly_subscription", "2500000", "Ongoing, bulanan", true, ["Trading AI"], ["Monthly trading support"]),
  ],
  "data-analytics": [
    svc("dashboard-setup", "Penyiapan Dashboard Analitik", "Penyiapan dashboard analitik bisnis.", "one_time", "2000000", "3-5 hari", false, ["Data Analyst AI"], ["Dashboard access"]),
    ...
    svc("data-analytics-monthly", "Data Analytics AI Bulanan", "Subscription pelaporan data bulanan.", "monthly_subscription", "2500000", "Ongoing, bulanan", true, ["Data Analyst AI"], ["Monthly analytics report"]),
  ],
  executive: [
    svc("strategic-review", "Review Keputusan Strategis", "Analisis pendukung keputusan strategis eksekutif.", "one_time", "3000000", "3-5 hari", true, ["Executive AI"], ["Strategic review document"]),
  ...
  "customer-service": [
    svc("support-macro-library", "Pustaka Respons Dukungan", "Kumpulan respons dukungan pelanggan siap pakai.", "one_time", "500000", "2-3 hari", false, ["Customer Service AI"], ["Macro library"]),
