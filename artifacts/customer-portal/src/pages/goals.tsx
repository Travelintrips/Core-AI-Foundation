 ...
 *
 * API: GET /api/ai/goals → { goals: GoalView[] }
    ...
    <Layout>
      <div className="bg-[#060B18] text-[#F0F4FF] min-h-screen">
        ...
        <section className="container mx-auto px-4 md:px-8 max-w-5xl py-12">
          ...
          {isLoading && (
            <>
              <h2 className="sr-only">Memuat tujuan bisnis…</h2>
              <div
          ...
          {!isLoading && !isError && goals && goals.length === 0 && (
            <div className="flex flex-col items-center gap-5 py-20 text-center">
              ...
              >
                <LayoutGrid className="w-7 h-7 text-[#7C6EFA]" aria-hidden="true" />
              </div>
              <div>
                <p className="font-semibold text-[#F0F4FF] mb-1">Belum ada tujuan tersedia</p>
                <p className="text-sm text-[#8B9BC4]">Tujuan bisnis akan segera hadir.</p>
              </div>
              <Link
                href="/services"
