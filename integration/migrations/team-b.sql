-- Team B — WP-04/WP-05: Soft Delete & Archive/Retention Migration Draft
-- Status: DRAFT — belum dijalankan. Jalankan setelah branch di-approve oleh Team 24.
--
-- Dokumen asli: scripts/migrations/wp04-wp05-soft-delete.sql
-- Aman dijalankan ulang: semua statement memakai IF NOT EXISTS / IF EXISTS.
-- Tidak ada DROP, TRUNCATE, atau rename destructive.
-- Semua perubahan additive terhadap tabel yang sudah ada.
