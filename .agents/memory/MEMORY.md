...
- [Git settings vs Agent auth](github-git-settings-vs-agent-auth.md) — Git UI may show GitHub Active while Agent-side push/auth remains unavailable; verify both paths
