...
**How to apply:** If a prompt-only commit is ahead of `origin/main`, stash the actual work, reset the feature branch and local `main` to `origin/main`, then reapply and commit only the product changes.